...
class GeniusComputerPlayer(Player):
    ...
    def get_move(self, game):
        if len(game.available_moves()) == 9:
            ...
            # get the square based on minmax algorithm
    ...
    def minmax(self, state, player):
        ...
        elif not state.num_empty_squares(): # no empty square
        ...
        for possible_move in state.available_moves():
            ...
            # Step 2: recurse using minmax to simulate a game after making that score
